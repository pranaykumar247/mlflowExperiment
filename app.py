...
if __name__ == '__main__':
    ...
    ## Reaa the wine-quality csv file from the URL
    csv_url = (
    ...
    try:
        ...
        logger.exception("Unable to downlaod training & test CSV, check your internt connections"
        )
...
with mlflow.start_run():
    ...
    (rsme,mae,r2) = eval_metrics(test_y, predicted_qualitites)
